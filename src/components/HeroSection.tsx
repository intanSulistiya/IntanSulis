    ...
    >
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 max-w-4xl mx-auto">
        ...
        <div className="flex justify-center gap-4 md:gap-6 mt-4">
          {/* Instagram */}
          <a href="https://instagram.com/Thv.sulis" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="group w-12 h-12 bg-gradient-to-br from-pink-100 to-blue-100 rounded-full flex items-center justify-center hover:bg-gradient-to-br hover:from-pink-200 hover:to-blue-200 transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-1">
          ...
          {/* GitHub */}
          <a href="https://github.com/intansulistiya" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="group w-12 h-12 bg-gradient-to-br from-blue-100 to-purple-100 rounded-full flex items-center justify-center hover:bg-gradient-to-br hover:from-blue-200 hover:to-purple-200 transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-1">
          ...
          {/* TikTok */}
          <a href="https://www.tiktok.com/@intannsulis?_t=ZS-8xWyYOijh28&_r=1" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="group w-12 h-12 bg-gradient-to-br from-purple-100 to-pink-100 rounded-full flex items-center justify-center hover:bg-gradient-to-br hover:from-purple-200 hover:to-pink-200 transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-1">
