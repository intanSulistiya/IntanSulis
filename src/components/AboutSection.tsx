...
export default function AboutSection() {
  ...
  return (
    <section
      ref={sectionRef}
      id="about"
      className="w-full py-20 px-1 bg-[#fafafa] relative overflow-hidden"
    >
      {/* Background Elements */}
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <div className="space-y-3">
            <h3 className="text-3xl md:text-4xl font-extrabold text-gray-900 font-plus-jakarta">
              Intan Sulistiya
            </h3>

            <p className="text-[#A52A2A] font-semibold text-lg">
              {t.about.role}
            </p>

            {/* Experience Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm border border-[#800000]/30 rounded-xl shadow-lg">
            ...
            <div className="flex justify-start gap-3 pt-2">
              {[
                ...
                <div
                  key={i}
                  className="w-16 h-16 bg-white/80 backdrop-blur-sm border-2 border-[#800000]/30 rounded-xl flex flex-col items-center justify-center
                    hover:scale-110 hover:border-[#A52A2A]/60 hover:shadow-xl hover:shadow-[#800000]/20 transition-all duration-300 group"
                >
                  <span className="text-[#A52A2A] font-extrabold text-lg group-hover:text-[#800000] transition-colors">
                    {item.short}
                  </span>
                  <span className="text-gray-600 text-xs group-hover:text-gray-800 transition-colors">{item.label}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className={`mt-4 transform transition-all duration-700 delay-200 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="w-full">
              <h3 className="text-xl font-bold text-gray-900 mb-3 font-plus-jakarta">{t.about.funFacts}</h3>
            ...
            {/* Services - Kanan */}
            <div>
              <h3 className="text-xl font-bold text-gray-900 mb-3 font-plus-jakarta">{t.about.services}</h3>
              <div className="space-y-2">
                {t.about.servicesItems.map((item, index) => (
                  <div
                    key={index}
                    className="bg-white/80 backdrop-blur-sm border-l-4 border-[#800000] rounded-r-xl p-4 hover:border-[#A52A2A] hover:shadow-xl hover:shadow-[#800000]/10 transition-all duration-300 group"
                  >
                    <div className="flex items-start gap-2.5">
                      ...
                      <div className="flex-1">
                        <h4 className="text-gray-900 font-bold text-sm mb-1 group-hover:text-[#A52A2A] transition-colors duration-300">
                          {item.title}
                        </h4>
